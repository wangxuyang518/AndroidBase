package com.xinyi_tech.commonlibs.widget.timeline;
...
public class TimelineView extends View {
    ...
    private void init(AttributeSet attrs) {
        ...
        mMarkerSize = typedArray.getDimensionPixelSize(R.styleable.TimelineView_marker_size, 25);
        mLineSize = typedArray.getDimensionPixelSize(R.styleable.TimelineView_line_size, 2);
        typedArray.recycle();

        if(mMarker == null) {
            mMarker = mContext.getResources().getDrawable(R.drawable.timeline_maker_nor);
        }
    }
